...
class BookingRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        user1 = userRepository.save(new User(1, "Bob", "bob@mail.com"));
        user2 = userRepository.save(new User(2, "Ray", "ray@mail.com"));
    ...
    void findOwn() {
        ...
        assertEquals("Bob", bookingPage.getContent().get(0).getItem().getOwner().getName());
    }
    ...
    void findBookingsByItemAndBooker() {
        ...
        assertEquals("Ray", bookings.get(0).getBooker().getName());
    }
}